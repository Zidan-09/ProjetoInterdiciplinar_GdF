...
class PatientRegistration {
    register(data: {name: string; dob: Date; maritalStatus: MaritalStatus; cpf: string, rg: string, contact: string[], gender: Gender, healthPlan: string, address: string}): Patient {
